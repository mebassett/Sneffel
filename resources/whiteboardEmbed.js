...
{
	//drawPad stuff
	$("#drawPadBox").css("width",sneffelWidth-32);	
	$("#drawPadBox").css("height",sneffelHeight-45);
	$("#controls").css("width",sneffelWidth);	
	$("#controls").css("height",sneffelHeight);	
	$('input.textPost').css("width",sneffelWidth-254);
